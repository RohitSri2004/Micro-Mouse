...
//Dynamically set time.. for which it moves forward, when it chooses forward over right. 
...
{
if((lsensor==false)&&(frontdist()>=40)) // If both front and right are open..
{
    i = i+1;
    j = j+1;
...
// right turn..
    ...
    {gofront(); delay(tlbef);}
        ...
        digitalWrite(L1, HIGH); // takes a right turn..
        digitalWrite(L2, LOW); 
        digitalWrite(R1, LOW); 
        digitalWrite(R2, LOW); 
        delay(2*t);
